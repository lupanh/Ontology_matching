...
public class FeatureSet implements java.io.Serializable {
	...
	public TreeMap<Integer, Integer> addStringFeatureVector(ArrayList<String> strFeatures,
			String label, boolean flagTest) {
		if (strFeatures == null)
			return null;
		return addStringFeatureVector(strFeatures.toArray(new String[strFeatures.size()]), label,
				flagTest);
	}
	...
	public static void main(String[] args) {
		...
		TreeMap<Integer, Integer> vector1 = featureSet.addStringFeatureVector(strVector1, "YES",
				false);
		TreeMap<Integer, Integer> vector2 = featureSet.addStringFeatureVector(strVector2, "NO",
				false);
